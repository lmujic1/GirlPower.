...
namespace GirlPower.Controllers
{
    public class AdministratorsController : Controller
    {
        ...
        public AdministratorsController(GirlPowerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Ime,Prezime,KorisnickoIme,Lozinka,EMailTelefon,Id")] Administrator administrator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Ime,Prezime,KorisnickoIme,Lozinka,EMailTelefon,Id")] Administrator administrator)
        {
